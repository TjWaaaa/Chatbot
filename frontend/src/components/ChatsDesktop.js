	...
	return (
		<div>
			...
			<div className="flex flex-row">
				<div className="overflow-y-scroll w-96 dark:bg-slate-600" style={{ height: 'calc(100vh - 60px)' }}>
				...
				<div className="bg-slate-100 dark:bg-slate-700 flex-1 overflow-y-scroll" style={{ height: 'calc(100vh - 60px)' }}>
					{currentChatId === -1 ? (
