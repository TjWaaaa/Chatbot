...
function Index() {
  ...
  return (
    <div className="pl-4 pr-4 pt-8 pb-4">
      <div>
        <h1 className={`text-3xl font-bold ${color}`} onClick={handleClick}>Error 404</h1>
        <h2 className="text-lg font-semibold pt-3 pb-5 ">Entschuldigung, diese Seite existiert nicht.</h2>
        <Link className="my-5 py-2 p-5 bg-indigo-600 shadow-lg shadow-indigo-600/50 hover:shadow-indigo-600/40 text-white font-semibold rounded-lg" to="/">
      Zurück zu den Chats
    </Link>
      </div>
    </div>
